...
public class itemAskPayment implements Serializable {
    @SerializedName("$id")
    @Expose
    private String $id;
    @SerializedName("ID")
    ...
    @SerializedName("Salle_Cost")
    @Expose
    private Double salleCost;
    ...
    public Double getSalleCost() {
        return salleCost;
    }

    public void setSalleCost(Double salleCost) {
        this.salleCost = salleCost;
    }
