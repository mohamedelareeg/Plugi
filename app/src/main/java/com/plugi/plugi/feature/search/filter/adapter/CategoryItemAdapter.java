...
public class CategoryItemAdapter extends RecyclerView.Adapter<CategoryItemAdapter.MostPopularViewHolder> {

    Context context;
    List<MainCategory.Category> itemList;
    ...
    public CategoryItemAdapter(Context context  , List<MainCategory.Category> itemList , int focusedItem, OnCategoryClickListener onCategoryClickListener ) {
    ...
    public void onBindViewHolder(@NonNull final MostPopularViewHolder holder, int position) {
        ...
        final MainCategory.Category item = itemList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                notifyItemChanged(focusedItem);
                onCategoryClickListener.onCategoryClicked(item , position);
            }
        });
