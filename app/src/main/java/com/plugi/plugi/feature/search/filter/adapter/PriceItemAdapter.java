...
public class PriceItemAdapter extends RecyclerView.Adapter<PriceItemAdapter.MostPopularViewHolder> {

    Context context;
    List<FilterIDs.PriceList> itemList;
    ...
    public PriceItemAdapter(Context context  , List<FilterIDs.PriceList> itemList , int focusedItem, OnPriceClickListener onPriceClickListener ) {
    ...
    public void onBindViewHolder(@NonNull final MostPopularViewHolder holder, int position) {
        ...
        final FilterIDs.PriceList item = itemList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                notifyItemChanged(focusedItem);
                onPriceClickListener.onPriceClicked(item , position);
            }
        });
