...
public class ReviewBidFragment extends BaseFragment implements IOnBackPressed {

    ProductShowCaseWebView wv;
    //ItemInfo
    private TextView productName, itemSize , item_size_type , item_size_gender , itemColor , item_placed_bid, item_all_fees , item_Total , shipAddress , shipCity , paymentMethod;
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_review_bid, container, false);
    ...
    public void onViewCreated(@NonNull View view, @androidx.annotation.Nullable Bundle savedInstanceState) {
        ...
        item_placed_bid = view.findViewById(R.id.item_placed_bid);
    ...
    private void setItemDetails(ReviewItem itemDetails) {
        ...
        item_placed_bid.setText(String.valueOf(itemValue));
