...
public class SellingPendingDetails extends BaseFragment implements IOnBackPressed {

    ProductShowCaseWebView wv;
    //ItemInfo
    private TextView productName, itemSize  , itemColor , itemData, itemCondition ,itemOrderNo , itemStatus , viewProduct , item_Purchase_price , item_Proceesing , item_Shipping , item_Tax , item_Total , item_bidAmount  , item_PurchaseDate , item_PaidCredit , shipAddress , shipCity;
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_buying_pending_details, container, false);
    ...
    private void setItemDetails(viewOrderDetails itemDetails) {
        ...
        viewProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bundle args = new Bundle();
                args.putInt(Constants.BUNDLE_ITEM_TYPE, 15);
...
//        }
    ...
    protected int layoutRes() {
        return R.layout.fragment_buying_pending_details;
    }
