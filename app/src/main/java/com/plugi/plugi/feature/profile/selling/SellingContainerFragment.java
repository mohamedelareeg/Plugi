...
public class SellingContainerFragment extends BaseFragment implements TabLayout.OnTabSelectedListener {
    ...
    public void onTabSelected(TabLayout.Tab tab) {
        switch (tab.getPosition())
        {
            ...
            {
                Fragment fragment = null;
                fragment = new CurrentSellingFragment();
            ...
            {
                Fragment fragment = null;
                fragment = new PendingSellingFragment();
                replaceItemFragments(fragment);
            ...
            {
                Fragment fragment = null;
                fragment = new HistorySellingFragment();
                replaceItemFragments(fragment);
                currentLine.setVisibility(View.INVISIBLE);
                pendingLine.setVisibility(View.INVISIBLE);
    ...
    public void LoadData() {
        if (SharedPrefManager.getInstance(getActivity()).isLoggedIn()) {
            ...
            //defining the call
            Call<customerSells> call = service.GetCustomer_Sells(
                    bodyToken
            );
            call.enqueue(new Callback<customerSells>() {
                @Override
                public void onResponse(Call<customerSells> call, Response<customerSells> response) {

                    if(response.body() != null) {
                        if (response.body().getStatusMessage().equals("Success")) {
                            ((MainActivity) getActivity()).setCustomerSells(response.body());
                            Fragment fragment = null;
                            fragment = new CurrentSellingFragment();
                            replaceItemFragments(fragment);
                            currentLine.setVisibility(View.VISIBLE);
                ...
                @Override
                public void onFailure(Call<customerSells> call, Throwable t) {
