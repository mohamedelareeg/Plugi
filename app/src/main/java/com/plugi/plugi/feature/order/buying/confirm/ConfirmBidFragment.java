...
public class ConfirmBidFragment extends BaseFragment implements IOnBackPressed {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_confirm_bid, container, false);
    ...
    public void LoadData(ReviewItem reviewItem)
    {
        ...
        jsonParams.put("bid_Cost", ((MainActivity) getActivity()).getItemValue());
        ...
        //defining the call
        Call<itemBidPayment> call = service.AddItemBid(
                bodyToken
        );
        call.enqueue(new Callback<itemBidPayment>() {
            @Override
            public void onResponse(Call<itemBidPayment> call, Response<itemBidPayment> response) {
            ...
            @Override
            public void onFailure(Call<itemBidPayment> call, Throwable t) {
    ...
    private void setItemDetails(ReviewItem itemDetails ,itemBidPayment itemBidPayment) {
    ...
    protected int layoutRes() {
        return R.layout.fragment_confirm_bid;
    }
