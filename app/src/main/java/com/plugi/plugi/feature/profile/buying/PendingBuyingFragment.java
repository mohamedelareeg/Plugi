...
public class PendingBuyingFragment extends BaseFragment implements IOnBackPressed , OnPendingClickListener {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_buying_pending, container, false);
    ...
    private void PojoData() {
        if(((MainActivity) getActivity()).getCustomerBids()!=null) {
            buyingCurrentList.addAll(((MainActivity) getActivity()).getCustomerBids().getPendingList());
