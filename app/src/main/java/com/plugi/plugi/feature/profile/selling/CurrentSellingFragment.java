...
public class CurrentSellingFragment extends BaseFragment implements IOnBackPressed  , OnCurrentClickListener , OnExpirationClickListener, OnCurrentEditClickListener {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_selling_current, container, false);
    ...
    private void PojoData() {
        if(((MainActivity) getActivity()).getCustomerSells()!=null) {
            buyingCurrentList.addAll(((MainActivity) getActivity()).getCustomerSells().getCurrentList());
    ...
    protected int layoutRes() {
        return R.layout.fragment_selling_current;
    }
    ...
    public void onCurrentClicked(CurrentList contact, int position) {
        ((MainActivity) requireActivity()).setViewAskDetails(null);
    ...
    public void onCurrentEditClicked(CurrentList contact, int position) {
        ...
        if(((MainActivity) getActivity()).getCustomerSells().getExpirationDaysList() != null) {
