...
import com.plugi.plugi.feature.order.buying.review.ReviewBidFragment;
...
public class PlaceBIDFragment extends BaseFragment implements IOnBackPressed , OnExpirationClickListener , OnAddressClickListener, OnPaymentMethodClickListener, OnItemSizeClickListener {
    ...
    private TextView productName , item_size_type , item_size_gender , item_size , itemColor , highestBID , lowestASK  , itemCurrency, itemStatus , item_Proceesing , item_Shipping , item_Tax  , item_Discount , item_Total , expiration_value , TxtWarring , TxtٍSubmitWarring;
    private ImageView select_Size , bid_Expiration , paymentMethod , shippingAddress;
    ShimmerFrameLayout shimmerFrameLayout;
    private ScrollView itemScrollView;
    private Button btnSubmit;

    //PopUpDialog
    public static Dialog sizeDialog , paymentDialog , addressDialog , expirationDialog , discountDialog;
    ...
    public void onViewCreated(@NonNull View view, @androidx.annotation.Nullable Bundle savedInstanceState) {
        ...
        bid_Expiration = view.findViewById(R.id.bid_Expiration);
    ...
    private void setItemDetails(ReviewItem itemDetails) {
        ...
        {
            lowestASK.setText(itemDetails.getItemDetail().getMaxBidPrice().toString());
        }
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(enterBID.getText())) {
                    ...
                    fragment = new ReviewBidFragment();
        ...
        bid_Expiration.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//        }
    ...
    protected int layoutRes() {
        return R.layout.fragment_place_bid;
    }
    ...
    public void showExpirationDialog(Activity activity , List<ExpirationDaysList> expirationList){
        ...
        ivClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bid_Expiration.setEnabled(true);
            }
        });
        int selectedIndex = -1;
        ...
        bid_Expiration.setEnabled(false);
    ...
    public void onItemSizeClicked(AllItemSize contact, int position) {
        ...
        if(selectedSize != null) {
            ...
            {
                lowestASK.setText(reviewItem.getItemDetail().getMaxBidPrice().toString());
            }
         ...
         */
        //lowestASK.setText( contact.getPriceCurrency()+"."+contact.getPriceValue());
    }
