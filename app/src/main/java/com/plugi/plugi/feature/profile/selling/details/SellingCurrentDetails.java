package com.plugi.plugi.feature.profile.selling.details;
...
public class SellingCurrentDetails extends BaseFragment implements IOnBackPressed , OnExpirationClickListener {
    ...
    private ViewAskDetails viewAskDetails;
    int itemID;
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        viewAskDetails = ((MainActivity) getActivity()).getViewAskDetails();
    ...
    public void onViewCreated(@NonNull View view, @androidx.annotation.Nullable Bundle savedInstanceState) {
        ...
        if(viewAskDetails != null) {
            setItemDetails(viewAskDetails);
        }
        else if(itemID != 0) {
            LoadData(itemID);
    ...
    public void LoadData(int _itemID)
    {
        ...
        //defining the call
        Call<ViewAskDetails> call = service.GetASKDetail(
                bodyToken
        );
        call.enqueue(new Callback<ViewAskDetails>() {
            @Override
            public void onResponse(Call<ViewAskDetails> call, Response<ViewAskDetails> response) {
                ...
                if(response.body() != null) {
                    if(response.body().getStatusMessage().equals("Success"))
                    {
                        if(response.body().getItemDetail() != null) {
                            ...
                            ((MainActivity) getActivity()).setViewAskDetails(response.body());
                        }
            ...
            @Override
            public void onFailure(Call<ViewAskDetails> call, Throwable t) {
                Log.d("ItemDetails", "onFailure: " + t.getLocalizedMessage());
            }
        });
    }

    private void setItemDetails(ViewAskDetails itemDetails) {
        ...
        else if(((MainActivity) getActivity()).getCustomerSells().getExpirationDaysList() != null  && ((MainActivity) getActivity()).getCustomerSells().getExpirationDaysList().size() > 0) {
            selectExpiration = ((MainActivity) getActivity()).getCustomerSells().getExpirationDaysList().get(0);
            //expiration_value.setText(selectExpiration.getPropValue() + getActivity().getResources().getString(R.string.day));
            ((MainActivity) getActivity()).setSelectExpiration(selectExpiration);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showExpirationDialog(getActivity(),((MainActivity) getActivity()).getCustomerSells().getExpirationDaysList());
                /*
                Fragment fragment = null;
        ...
        viewProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bundle args = new Bundle();
                args.putInt(Constants.BUNDLE_ITEM_TYPE, 14);
...
//        }
    ...
    public void setExpireDate(int _itemID)
    {
        ...
        RequestBody bodyToken = RequestBody.create(MediaType.parse("application/json; charset=utf-8"),(new JSONObject(jsonParams)).toString());
        //defining the call
        Call<UpdateBidExpire> call = service.UpdateASKExpireDate(
                bodyToken
        );
