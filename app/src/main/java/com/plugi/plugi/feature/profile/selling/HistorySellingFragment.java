...
public class HistorySellingFragment extends BaseFragment implements IOnBackPressed , OnHistoryClickListener {
    ...
    private void PojoData() {
        if(((MainActivity) getActivity()).getCustomerSells()!=null) {
            buyingCurrentList.addAll(((MainActivity) getActivity()).getCustomerSells().getHistoryList());
    ...
    protected int layoutRes() {
        return R.layout.fragment_selling_history;
    }
