...
public class HomeHighestBidsAdapter extends RecyclerView.Adapter<HomeHighestBidsAdapter.LowestAskViewHolder> {

    Context context;
    List<HomeScreen.HightestBidsItem> categoryItemsList;
    OnItemClickListener onItemClickListener;
    int categoryID;
    public HomeHighestBidsAdapter(Context context  , List<HomeScreen.HightestBidsItem> categoryItemsList , int categoryID  , OnItemClickListener onItemClickListener) {
    ...
    public LowestAskViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.item_highest_bids, parent, false);
    ...
    public void onBindViewHolder(@NonNull final LowestAskViewHolder holder, int position) {
        ...
        final HomeScreen.HightestBidsItem categoryItems = categoryItemsList.get(position);
