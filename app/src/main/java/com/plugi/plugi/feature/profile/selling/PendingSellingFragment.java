package com.plugi.plugi.feature.profile.selling;
...
import com.plugi.plugi.feature.profile.buyingselling.adapter.PendingBuyingAdapter;
...
public class PendingSellingFragment extends BaseFragment implements IOnBackPressed , OnPendingClickListener {

    ShimmerFrameLayout parentShimmerLayout , parentShimmerLayout2 ;
    private ScrollView itemScrollView;

    PendingBuyingAdapter pendingBuyingAdapter;
    List<PendingList> buyingCurrentList;
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_selling_pending, container, false);
    ...
    private void PojoData() {
        if(((MainActivity) getActivity()).getCustomerSells()!=null) {
            buyingCurrentList.addAll(((MainActivity) getActivity()).getCustomerSells().getPendingList());
            Log.d("BUYING", "PojoData: " + buyingCurrentList.size());
            pendingBuyingAdapter.notifyDataSetChanged();
    ...
    private void AssignAddress() {
         ...
         */
        pendingBuyingAdapter = new PendingBuyingAdapter(getActivity(), buyingCurrentList , this);
        rec_Current_Buying.setAdapter(pendingBuyingAdapter);
    ...
    protected int layoutRes() {
        return R.layout.fragment_selling_pending;
    }
    ...
    @Override
    public void onPendingClicked(PendingList contact, int position) {
