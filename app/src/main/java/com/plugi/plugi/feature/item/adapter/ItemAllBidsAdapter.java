...
public class ItemAllBidsAdapter extends RecyclerView.Adapter<ItemAllBidsAdapter.MostPopularViewHolder> {

    Context context;
    List<AllitemBid> categoryItemsList;
    // Start with first item selected
    private int focusedItem = 0;



    public ItemAllBidsAdapter(Context context  , List<AllitemBid> categoryItemsList ) {
    ...
    public void onBindViewHolder(@NonNull final MostPopularViewHolder holder, int position) {
        ...
        final AllitemBid categoryItems = categoryItemsList.get(position);
