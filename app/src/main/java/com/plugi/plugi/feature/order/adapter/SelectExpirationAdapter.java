...
public class SelectExpirationAdapter extends RecyclerView.Adapter<SelectExpirationAdapter.MostPopularViewHolder> {

    Context context;
    List<ExpirationDaysList> itemList;
    OnExpirationClickListener onExpirationClickListener;
    ...
    public SelectExpirationAdapter(Context context  , List<ExpirationDaysList> itemList , int focusedItem, OnExpirationClickListener onExpirationClickListener ) {
        this.context = context;
        this.itemList = itemList;
        this.focusedItem = focusedItem;
        this.onExpirationClickListener = onExpirationClickListener;
    ...
    public MostPopularViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.item_expiration, parent, false);
    ...
    public void onBindViewHolder(@NonNull final MostPopularViewHolder holder, int position) {
        ...
        final ExpirationDaysList item = itemList.get(position);
        holder.itemName.setText(item.getPropValue() + context.getResources().getString(R.string.day));
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                notifyItemChanged(focusedItem);
                onExpirationClickListener.onExpirationClicked(item , position);
            }
        });
