...
public class SearchItemsAdapter extends RecyclerView.Adapter<SearchItemsAdapter.MostPopularViewHolder> {

    Context context;
    List<SearchItems.Item> categoryItemsList;
    OnRelatedItemClickListener onRelatedItemClickListener;
    public SearchItemsAdapter(Context context  , List<SearchItems.Item> categoryItemsList , OnRelatedItemClickListener onRelatedItemClickListener) {
