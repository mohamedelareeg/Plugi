...
public class BuyingFragment extends BaseFragment implements IOnBackPressed , OnAddressClickListener , OnPaymentMethodClickListener {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_setting_buying, container, false);
