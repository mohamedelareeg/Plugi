...
public class ItemEndPropertiesAdapter extends RecyclerView.Adapter<ItemEndPropertiesAdapter.MostPopularViewHolder> {

    Context context;
    List<Proptety> categoryItemsList;


    public ItemEndPropertiesAdapter(Context context  , List<Proptety> categoryItemsList ) {
    ...
    public MostPopularViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.item_end_properties, parent, false);
