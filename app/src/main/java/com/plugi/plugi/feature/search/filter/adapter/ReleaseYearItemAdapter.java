...
public class ReleaseYearItemAdapter extends RecyclerView.Adapter<ReleaseYearItemAdapter.MostPopularViewHolder> {

    Context context;
    List<FilterIDs.ReleaseYearList> itemList;
    OnReleaseYearClickListener onReleaseYearClickListener;
    ...
    public ReleaseYearItemAdapter(Context context  , List<FilterIDs.ReleaseYearList> itemList , int focusedItem, OnReleaseYearClickListener onReleaseYearClickListener ) {
        this.context = context;
        this.itemList = itemList;
        this.focusedItem = focusedItem;
        this.onReleaseYearClickListener = onReleaseYearClickListener;
    ...
    public void onBindViewHolder(@NonNull final MostPopularViewHolder holder, int position) {
        ...
        final FilterIDs.ReleaseYearList item = itemList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                notifyItemChanged(focusedItem);
                onReleaseYearClickListener.onReleaseYearClicked(item , position);
            }
        });
