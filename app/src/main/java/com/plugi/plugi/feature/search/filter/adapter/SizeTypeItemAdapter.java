...
public class SizeTypeItemAdapter extends RecyclerView.Adapter<SizeTypeItemAdapter.MostPopularViewHolder> {

    Context context;
    List<FilterIDs.SizeTypeList> itemList;
    OnSizeTypeClickListener onSizeTypeClickListener;
    ...
    public SizeTypeItemAdapter(Context context  , List<FilterIDs.SizeTypeList> itemList , int focusedItem, OnSizeTypeClickListener onSizeTypeClickListener ) {
        this.context = context;
        this.itemList = itemList;
        this.focusedItem = focusedItem;
        this.onSizeTypeClickListener = onSizeTypeClickListener;
    ...
    public void onBindViewHolder(@NonNull final MostPopularViewHolder holder, int position) {
        ...
        final FilterIDs.SizeTypeList item = itemList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                notifyItemChanged(focusedItem);
                onSizeTypeClickListener.onSizeTypeClicked(item , position);
            }
        });
