...
import com.plugi.plugi.feature.order.selling.review.ReviewAskFragment;
...
public class PlaceAskFragment extends BaseFragment implements IOnBackPressed , OnExpirationClickListener , OnPaymentMethodClickListener, OnItemSizeClickListener {
    ...
    private TextView productName, item_size_type , item_size_gender, item_size , itemColor , highestBID , lowestASK  , itemCurrency, itemStatus , item_Proceesing , payment_proc , item_Shipping , item_Tax  , item_Discount , item_Total , expiration_value , TxtWarring , TxtٍSubmitWarring;
    private ImageView select_Size , ask_Expiration , getPaid;
    ...
    //PopUpDialog
    public static Dialog sizeDialog , expirationDialog , paymentDialog , discountDialog;
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_place_ask, container, false);
    ...
    public void onViewCreated(@NonNull View view, @androidx.annotation.Nullable Bundle savedInstanceState) {
        ...
        expiration_value = view.findViewById(R.id.expiration_value);
        ...
        ask_Expiration = view.findViewById(R.id.ask_Expiration);
    ...
    private void setItemDetails(ReviewItem itemDetails) {
        ...
        {
            highestBID.setText(itemDetails.getItemDetail().getLowAskPrice().toString());
        }
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(enterBID.getText())) {
                    ...
                    fragment = new ReviewAskFragment();
        ...
        ask_Expiration.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showExpirationDialog(getActivity(),((MainActivity) getActivity()).getExpirationList());
            }
        });
        ...
        enterBID.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                try {
                    ...
                    sumTotal = itemValue + itemDetails.getPlugiProcessingFees() + reviewItem.getPaymentFees() + reviewItem.getTransactionFees() + shippingFees + itemDetails.getTaxFees() - itemDetails.getDiscountCost();
                    if(((MainActivity) getActivity()).getSelectedDiscount() != null)
                    {
    ...
    private void AssignDefault(ReviewItem itemDetails) {
        ...
        {
            if(((MainActivity) getActivity()).getExpirationList() != null  && ((MainActivity) getActivity()).getExpirationList().size() > 0) {
...
//        }
    ...
    public void showExpirationDialog(Activity activity , List<ExpirationDaysList> expirationList){
        ...
        ivClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ask_Expiration.setEnabled(true);
            }
        });
        int selectedIndex = -1;
        ...
        ask_Expiration.setEnabled(false);
    ...
    public void onItemSizeClicked(AllItemSize contact, int position) {
        ...
        if(selectedSize!=null ) {
            ...
            {
                highestBID.setText(reviewItem.getItemDetail().getLowAskPrice().toString());
            }
