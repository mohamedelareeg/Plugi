...
public class CategorySearchFragmentAdapter extends FragmentPagerAdapter implements IFTabAdapter {

    private MainCategory mainCategory;
    private Context context;
    public CategorySearchFragmentAdapter(FragmentManager fm , MainCategory mainCategory  , Context context) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        return CategorySearchFragment.newInstance(mainCategory.getCategories().get(position) , position  , context);
    }
