...
public class SearchResultAdapter extends RecyclerView.Adapter<SearchResultAdapter.MostPopularViewHolder> {

    Context context;
    List<SearchItems.Item> categoryItemsList;

    OnRelatedItemClickListener onRelatedItemClickListener;
    public SearchResultAdapter(Context context  , List<SearchItems.Item> categoryItemsList   , OnRelatedItemClickListener onRelatedItemClickListener) {
    ...
    public MostPopularViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.item_most_popular, parent, false);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               onRelatedItemClickListener.onItemClicked(categoryItems.getItemId());
                Log.d("ItemDetails", "onClick: " + categoryItems.getItemId());
        }
        });
