...
public class SizeItemAdapter extends RecyclerView.Adapter<SizeItemAdapter.MostPopularViewHolder> {

    Context context;
    List<FilterIDs.SizeList> itemList;
    ...
    public SizeItemAdapter(Context context  , List<FilterIDs.SizeList> itemList , int focusedItem, OnSizeClickListener onSizeClickListener ) {
    ...
    public void onBindViewHolder(@NonNull final MostPopularViewHolder holder, int position) {
        ...
        final FilterIDs.SizeList item = itemList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                notifyItemChanged(focusedItem);
                onSizeClickListener.onSizeClicked(item , position);
            }
        });
