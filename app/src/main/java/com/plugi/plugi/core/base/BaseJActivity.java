...
import com.plugi.plugi.core.utilities.LocaleHelper;
...
public class BaseJActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        ...
        //getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_RTL); TODO FORCE RTL DIRECTION
