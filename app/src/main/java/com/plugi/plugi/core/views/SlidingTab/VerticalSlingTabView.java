...
//        Log.e("TAG", "Left: " + left + "/right: " + right + "/width: " + width + "/height: " + height);
            ...
            Drawable d = getResources().getDrawable(R.drawable.ic_line_blue, null);
            d.setBounds((int)left, height - tabModel.getTabHeightUnderLine(), (int)right, height);
            d.draw(canvas);
    ...
    public void setPaintUnderLine(Drawable mPaintUnderLine) {
