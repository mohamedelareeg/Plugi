...
public class UltimateTabLayout extends FrameLayout {
    ...
    private final int DEFAULT_COLOR_UNDER_LINE = R.drawable.ic_line_blue;//Color.parseColor("#000000")
    ...
    private Drawable tabUnderLineColor;
    ...
    private Drawable mPaintUnderLine;
    ...
    private void init(Context context, AttributeSet attrs, int def){
        ...
        tabTextSize = ta.getFloat(R.styleable.UltimateTabLayout_tab_slide_text_size, 14f);
        tabTextColor = ta.getResourceId(R.styleable.UltimateTabLayout_tab_slide_text_color, R.color.tab_color_selected_default);

        tabUnderLineShow = ta.getBoolean(R.styleable.UltimateTabLayout_tab_under_line_show, true);
        TypedArray a = context.obtainStyledAttributes(R.style.AppTheme, new int[] {R.styleable.UltimateTabLayout_tab_under_line_color});
        int attributeResourceId = a.getResourceId(0, 0);
        tabUnderLineColor = ta.getDrawable(attributeResourceId);
        ...
        mPaintUnderLine = tabUnderLineColor;
...
//        setWillNotDraw(false);
    ...
    public void setTabUnderLineColor(Drawable tabUnderLineColor) {
