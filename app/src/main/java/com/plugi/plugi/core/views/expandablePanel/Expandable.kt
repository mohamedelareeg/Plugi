package com.plugi.plugi.core.views.expandablePanel
...
class Expandable : FrameLayout {
    ...
    private fun createExpandIcon() {
        ...
        expandIcon.apply {
            layoutParams = LayoutParams(iconSize, iconSize, Gravity.END or Gravity.CENTER_VERTICAL)
                    .apply { setMargins(padding, 0, padding, 0) }
            //setImageDrawable(if (expandIndicator == null) ContextCompat.getDrawable(context, R.drawable.ic_plus) else expandIndicator)
        }
